...
public record Solucao5(
    ...
    public TreeNode<Posicao> encontrarPasseioDoCavalo5(Posicao posicaoInicial) {
        ...
        if (tabuleiro.dimensao() * tabuleiro.dimensao() > 63) {
            throw new IllegalArgumentException("This implementations supports a maximum of 63 visited positions, but the given board requires " + (tabuleiro.dimensao() * tabuleiro.dimensao()) + ".");
        }
